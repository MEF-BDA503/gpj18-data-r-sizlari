...
* Serhan Süer [Github](https://mef-bda503.github.io/pj18-SerhanSuer/),
...
- The major price changes for each category are:
  ...
  - Miscellaneous Food: Cacao and instant coffee
...
- Please see our Shiny app if you want to explore more on the prices ***(Shiny link to be added!!!!!!!)***.
...
According to yearly average price for vegetables and fruits graph, cucumbers, eggplants and onions have significant price increases in 2018.  
...
*	[Cumhuriyet news about cacao](http://www.cumhuriyet.com.tr/haber/gurme/930802/Kakaonun_gelecegi_tehlike_altinda...__Cikolata_40_yil_icinde_yok_olabilir_.html)
